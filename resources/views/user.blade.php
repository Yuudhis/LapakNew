...
<body>
    ...
    {{-- pricing section --}}
    <section class="grid justify-center my-10" id="price">
    ...
    {{-- history section --}}
    <section class="mx-32 my-20">
        
        <h1 class="inline-flex justify-center mb-10 text-6xl font-extrabold text-transparent bg-clip-text bg-gradient-to-r from-purple-400 to-pink-600">Purchase History</h1>
